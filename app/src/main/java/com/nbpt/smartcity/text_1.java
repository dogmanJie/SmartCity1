...
public class text_1 extends SQLiteOpenHelper {
    ...
    public text_1(Context context,int version) {
        super(context, DB_NAME_1, null, version);
        this.mcontext = context;
    }
    public Cursor select(String where, String orderby){
        StringBuilder stringBuilder = new StringBuilder("SELECT * FROM " + TABLE_Name_1+" where gender='女' ");
        if (where != null){
